...
function DetailedProfile({ profile, setBasicView }: DetailedProfileProps) {
  return (
    <div className="fixed inset-0 z-20 lg:z-0 lg:static overflow-y-auto pb-12 lg:pb-6 bg-gray-200 flex flex-col items-center lg:shadow-2xl lg:w-[400px] lg:h-[600px]">
      {/* Gradient */}
